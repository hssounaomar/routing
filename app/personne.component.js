...
var PersonneComponent = (function () {
    ...
    PersonneComponent.prototype.getPersonnes = function () {
        var _this = this;
        this.personneService.getPersonnes().then(function (personnes) { return _this.personnes = personnes; });
    };
    PersonneComponent.prototype.ngOnInit = function () {
        this.getPersonnes();
    };
    PersonneComponent.prototype.onSelect = function (per) { this.selectedHero = per; };
    PersonneComponent = __decorate([
        core_1.Component({
            selector: 'personne',
            template: "\n     <ul>\n   <li *ngFor=\"let hero of personnes\" [class.selected]=\"hero === selectedHero\"\n        (click)=\"onSelect(hero)\">\n   <p> <b>{{hero.id}} </b> {{hero.name}}   </p>\n    </li> \n    </ul>\n    <my-hero-detail [hero]=\"selectedHero\"></my-hero-detail>\n   ",
